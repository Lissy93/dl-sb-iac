 ...
 */
export function getSupabaseClient(req: Request, allowAnon?: boolean): SupabaseClient {
...
export async function getUserOrNull(req: Request, allowAnon?: boolean): Promise<User | null> {
